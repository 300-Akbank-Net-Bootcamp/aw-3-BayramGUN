...
public record GetAccountTransactionByParameterQuery(DateTime? TransactionDate = null, string? ReferenceNumber = null) : IRequest<ApiResponse<List<AccountTransactionResponse>>>;

...
public record GetEftTransactionByParameterQuery(DateTime? TransactionDate = null, string? ReferenceNumber = null) : IRequest<ApiResponse<List<EftTransactionResponse>>>;
